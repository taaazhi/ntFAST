...
class PatternDetector:
        ...
        for inc in income_txs:
            ...
            patterns.append(FlaggedPattern(
                ...
                counter_evidence=(
                    ...
                    "групповой сбор средств (свадьба, лечение), "
                    "возврат долгов нескольким людям."
                ),
                regulatory_reference=(
                    "УК РК ст. 218 (легализация (отмывание) денег и (или) иного "
                    "имущества, полученных преступным путём); "
                    "ЗРК О ПОД/ФТ ст. 4, п. 1; FATF Recommendation 1"
                )
            ))
    ...
    def _detect_carding(
        ...
        for burst in bursts:
            ...
            patterns.append(FlaggedPattern(
                ...
                regulatory_reference=(
                    "УК РК ст. 232 (изготовление или сбыт поддельных платёжных "
                    "карточек); ст. 190 (мошенничество); FATF R.15"
                )
            ))
    ...
    def _detect_pyramid_scheme(
        ...
        patterns.append(FlaggedPattern(
            ...
            regulatory_reference=(
                "УК РК ст. 217 (создание и руководство финансовой "
    ...
    def _detect_human_trafficking(
        ...
        patterns.append(FlaggedPattern(
            ...
            regulatory_reference="УК РК ст. 128 (торговля людьми); ЗРК О ПОД/ФТ ст. 4"
        ))
        return patterns
    ...
    def _detect_tax_evasion(
        ...
        patterns.append(FlaggedPattern(
            ...
            regulatory_reference=(
                "НК РК ст. 321 (доходы, включаемые в годовой доход физического "
                "лица); ЗРК О ПОД/ФТ ст. 11 (обязательный финансовый мониторинг)"
            )
        ))
        return patterns
